...
$.widget = function( name, base, prototype ) {
  ...
  $.each( prototype, function( prop, value ) {
    ...
    proxiedPrototype[ prop ] = (function() {
      ...
      return function() {
        var pica__super = this._super,
          pica__superApply = this._superApply,
          returnValue;
        ...
        this._super = pica__super;
        this._superApply = pica__superApply;
